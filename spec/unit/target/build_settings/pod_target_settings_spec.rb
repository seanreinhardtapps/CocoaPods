      ...
      describe PodTargetSettings do
        describe 'in general' do
          before do
            ...
            vendored_dep_target.stubs(:build_settings_by_config => { :debug => PodTargetSettings.new(vendored_dep_target, nil, :configuration => :debug) })
          ...
          it 'does propagate framework or libraries' do
            ...
            pod_target.stubs(:build_settings_by_config => { :debug => PodTargetSettings.new(pod_target, nil, :configuration => :debug) })
